 ...
 *
 * <p>The on-disk shape is unchanged from previous versions — {@code {"minecraft:sharpness": 3}}
 * — because {@code ResourceLocationTypeAdapter} reads and writes map keys as strings.
 */
@Getter
@Setter
@NoArgsConstructor
