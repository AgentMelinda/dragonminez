 ...
 * <ul>
 *   <li>{@link #GSON} pretty-prints, for files on disk and datagen output, which people
 *       read and edit by hand.</li>
 *   <li>{@link #NETWORK} is compact. Sync packets are size-bounded
 *       ({@code FriendlyByteBuf.writeUtf} caps at 1 MiB), and indentation on a large quest
 *       registry is pure overhead against that cap.</li>
 * </ul>
 */
