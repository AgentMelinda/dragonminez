 ...
 *
 * <p>Same rationale as {@link GenericItemTypeAdapterFactory}: delegating through
 * {@link Gson#getDelegateAdapter} means a wish's nested item DTOs are handled by the
 * outer Gson and keep their adapters, instead of being reflected over by a throwaway
 * instance that would flatten every {@code GenericItemDTO} subtype back to the base class.
 */
