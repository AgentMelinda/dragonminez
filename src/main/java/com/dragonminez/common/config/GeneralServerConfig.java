...
public class GeneralServerConfig {
	...
	public static class GameplayConfig {
		...
		private List<String> helmetsThatKeepHair = new ArrayList<>(Arrays.asList("dragonminez:invencible_armor_helmet", "dragonminez:invencible_blue_armor_helmet"));
		...
		private static Map<TpSource, List<TpBoost>> defaultTpGainBoosts() {
			...
			for (TpSource source : TpSource.values()) {
				List<TpBoost> boosts = new ArrayList<>(Arrays.asList(TpBoost.CLASS, TpBoost.RACIALSKILL, TpBoost.HTC, TpBoost.GRAVITY, TpBoost.WEIGHTS, TpBoost.GLOBAL, TpBoost.POTION, TpBoost.MUTANT));
		...
		@java.lang.SuppressWarnings("all")
		public CapsulesConfig getCapsules() {
	...
	public static class CapsulesConfig {
		...
		public CapsulesConfig() {
			Arrays.stream(CapsuleType.values()).forEach(type -> {
				values.put(type, new CapsuleValues(type.getStatName(), 5));
			});
		}

		public CapsuleValues getCapsuleValues(CapsuleType type) {
			return values.getOrDefault(type, new CapsuleValues(type.getStatName(), type.getStatPoints()));
		}
		...
		@java.lang.SuppressWarnings("all")
		public Map<CapsuleType, CapsuleValues> getValues() {
			return this.values;
		}
	}
	...
	public static class CapsuleValues {
		...
		@java.lang.SuppressWarnings("all")
		public CapsuleValues(final String stats, final Integer points) {
			this.stats = stats;
			this.points = points;
		}
	...
	public static class GravityConfig {
		...
		public Double getTpCurveWidth() {
			return Math.max(1.0E-4, tpCurveWidth != null ? tpCurveWidth : 7.0);
		}

		public Double getTpIdealBaseDivisor() {
			return Math.max(1.0E-4, tpIdealBaseDivisor != null ? tpIdealBaseDivisor : 2.0);
		}
		...
		public Double getTpOverloadHardRatio() {
			...
			return Math.max(getTpOverloadRatio() + 1.0E-4, value);
		}
	...
	public static class MutantConfig {
		...
		public Double getChance() {
			Double value = chance != null ? chance : 0.2;
			return Math.max(0.0, Math.min(value, 1.0));
		}
		...
		public Double getMasteryGainMultiplier() {
			return Math.max(0.0, masteryGainMultiplier != null ? masteryGainMultiplier : 1.5);
		}
	...
	@java.lang.SuppressWarnings("all")
	public RacialSkillsConfig getRacialSkills() {
		return this.racialSkills;
	}

	@java.lang.SuppressWarnings("all")
	public DynamicGrowthConfig getDynamicGrowth() {
	...
	@java.lang.SuppressWarnings("all")
	public DeveloperConfig getDeveloper() {
